    ...
    <SiteShell>
      ...
      <section className="bg-primary text-primary-foreground py-20 lg:py-28 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6">Grow Your Business with Narayani Distributors</h1>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">The Narayani Distributors Advantage</h2>
          </div>
      ...
      <section className="py-20 bg-muted/20">
        <div className="container mx-auto px-4 max-w-2xl text-center">
          <h2 className="text-3xl font-serif font-bold mb-4">Ready to Partner with Narayani Distributors?</h2>
