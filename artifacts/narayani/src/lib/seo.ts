...
const DEFAULT_TITLE = "Narayani Distributors | Mindful Eating Meets Joyful Snacking";
...
export function useSeo(options: SeoOptions) {
  ...
  const fullTitle = title ? (title.includes("Narayani Distributors") ? title : `${title} | Narayani Distributors`) : DEFAULT_TITLE;
  ...
  useEffect(() => {
    ...
    upsertMeta('meta[property="og:site_name"]', "property", "og:site_name", "Narayani Distributors");
