...
export function AdminShell({ children }: AdminShellProps) {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      <div className="p-6">
        <div className="mb-8">
          <span className="font-serif text-xl font-bold text-primary block">Narayani Distributors</span>
    ...
    <div className="flex h-screen overflow-hidden bg-muted/20">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <div className="lg:hidden flex items-center gap-3 px-4 h-14 bg-card border-b shrink-0">
          ...
          <span className="font-serif font-bold text-primary">Narayani Distributors Admin</span>
        </div>
