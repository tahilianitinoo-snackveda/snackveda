...
export default function Blog() {
  ...
  useSeo({
    ...
    description:
      "Recipes, nutrition guides and snacking stories from Narayani Distributors — healthy chips, roasted makhana and superpuffs made in India.",
    canonical: "/blog",
    jsonLd: {
      "@context": "https://schema.org",
      "@type": "Blog",
      name: "Narayani Distributors Blog",
      url: `${SITE_URL}/blog`,
      publisher: {
        "@type": "Organization",
    ...
    <SiteShell>
      <div className="border-b bg-muted/30 py-10">
        <div className="container mx-auto px-4">
          <h1 className="mb-3 font-serif text-3xl font-bold md:text-4xl">The Narayani Distributors Journal</h1>
